...
namespace smartsuite.bussinesLogic
{
    ...
    public partial class MessageTransaction
    {
        ...
        {
            this.MessageTransactionResponse = new HashSet<MessageTransactionResponse>();
        }
        ...
        public virtual ICollection<MessageTransactionResponse> MessageTransactionResponse { get; set; }
    }
}
